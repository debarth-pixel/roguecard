...
MIN_SUPPORTED_WIDTH = 960
MIN_SUPPORTED_HEIGHT = 540
FRAME_RATE = 60
...
SHOP_CARD_OFFER_COUNT = 4
SHOP_RELIC_OFFER_COUNT = 3
...
SHOP_HEAL_PRICE = 18
SHOP_HEAL_AMOUNT = 14
SHOP_CLEANSE_OFFER_ID = "cleanse_service"
SHOP_CLEANSE_PRICE_MULTIPLIER = 3
